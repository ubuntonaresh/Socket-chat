"""
Django settings for CodingWithMitchChat project.
...
ROOT_URLCONF = 'CodingWithMitchChat.urls'
...
WSGI_APPLICATION = 'CodingWithMitchChat.wsgi.application'

ASGI_APPLICATION = 'CodingWithMitchChat.routing.application'
